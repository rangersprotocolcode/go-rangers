...
type NodeDatabase struct {
	diskdb xdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb xdb.Database) *NodeDatabase {
	return &NodeDatabase{
		diskdb:    diskdb,
...
func (db *NodeDatabase) commit(hash common.Hash, batch xdb.Batch) error {
