...
func newInstructionSet() JumpTable {
	...
	instructionSet[NFT_TRANSFERNFT] = &operation{
		execute:     opTransferNFT,
		constantGas: 0,
		minStack:    minStack(3, 3),
		maxStack:    maxStack(3, 3),
	}

	instructionSet[NFT_SHUTTLENFT] = &operation{
		execute:     opShuttleNFT,
		constantGas: 0,
		minStack:    minStack(4, 4),
		maxStack:    maxStack(4, 4),
	}

	instructionSet[NFT_APPROVENFT] = &operation{
		execute:     opApproveNFT,
		constantGas: 0,
		minStack:    minStack(3, 3),
		maxStack:    maxStack(3, 3),
	}

	instructionSet[NFT_REVOKENFT] = &operation{
		execute:     opRevokeNFT,
		constantGas: 0,
	...
	instructionSet[NFT_REMOVENFT] = &operation{
		execute:     opRemoveNFT,
		constantGas: 0,
		minStack:    minStack(2, 2),
		maxStack:    maxStack(2, 2),
	...
	instructionSet[NFT_UPDATEDATA] = &operation{
		execute:     opUpdateData,
		constantGas: 0,
		minStack:    minStack(5, 5),
		maxStack:    maxStack(5, 5),
	}

	instructionSet[NFT_GETDATA] = &operation{
		execute:     opGetData,
		constantGas: 0,
		minStack:    minStack(4, 4),
		maxStack:    maxStack(4, 4),
	...
	instructionSet[NFT_ISEXISTEDNFTSET] = &operation{
		execute:     opIsExistedNFTSet,
		constantGas: 0,
		minStack:    minStack(1, 1),
		maxStack:    maxStack(1, 1),
	}

	instructionSet[NFT_ISEXISTEDNFT] = &operation{
		execute:     opIsExistedNFT,
		constantGas: 0,
		minStack:    minStack(2, 2),
		maxStack:    maxStack(2, 2),
	}

	instructionSet[NFT_GETNFTLIST] = &operation{
		execute:     opGetNFTList,
		constantGas: 0,
		minStack:    minStack(1, 1),
		maxStack:    maxStack(1, 1),
	}
