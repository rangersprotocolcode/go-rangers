...
func TestAuth(t *testing.T) {
	msgList := []string{"", ""}
	bytes := make([]byte, 0)
	...
	contractAddress := common.HexToAddress("0xae32129c3257f7e7bcb4328f20b63f8a13f8b99d")

	var commitHash [32]byte
	copy(commitHash[:], commitByte[:])
	hash := calAuthHash(big.NewInt(9527), contractAddress, commitHash)
	fmt.Printf("hash:%s\n", common.ToHex(hash))
